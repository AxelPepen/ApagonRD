...
export default plugin(({config, addBase, addComponents, addVariant, e}) => {
    ...
    addComponents({
        '.menu': {
            ...
            'cursor': 'pointer', 'display': 'flex', 'align-items': 'center', 'flex-grow': '1',
        }, '.menu-title': {
            'display': 'flex', 'align-items': 'center', 'line-height': '1', 'flex-grow': '1',
        }, '.menu-icon, .menu-bullet, .menu-badge, .menu-arrow': {
            'display': 'flex', 'align-items': 'center', 'flex-shrink': '0',
        }, '.menu-dropdown, .menu-accordion': {
            'padding': '0', 'margin': '0', 'display': 'none', 'align-items': 'stretch', 'flex-direction': 'column'
        }, '.menu-dropdown': {
    ...
    addVariant('menu-item-active', [({modifySelectors, separator}) => {
    ...
    addVariant('menu-item-here', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('menu-item-show', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('menu-item-disabled', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('menu-link-hover', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('menu-link-focus', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // DataTable
    addVariant('datatable-loading', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('datatable-initialized', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('datatable-sort', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('datatable-sort-asc', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('datatable-sort-desc', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // Accordion
    addVariant('accordion-active', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
            return `[data-accordion-item].active.${e(`accordion-active${separator}${className}`,)}`;
        });
    }, ({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
            return `[data-accordion-item].active > [data-accordion-toggle] .${e(`accordion-active${separator}${className}`,)}`;
        });
    }, ({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
            return `[data-accordion-item].active > [data-accordion-toggle].${e(`accordion-active${separator}${className}`,)}`;
    ...
    // Drawer
    addVariant('drawer-open', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // Dropdown
    addVariant('dropdown-open', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // Toggle
    addVariant('toggle-active', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // Sticky
    addVariant('sticky-active', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // Collapse
    addVariant('collapse-active', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // Button
    addVariant('btn-active', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // Toggle Password
    addVariant('toggle-password-active', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // Image Input
    addVariant('image-input-empty', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
            return `[data-image-input].empty .${e(`image-input-empty${separator}${className}`)}`;
        });
    },]);

    addVariant('image-input-changed', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    // Stepper
    addVariant('stepper-first', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
            return `[data-stepper].first .${e(`stepper-first${separator}${className}`)}`;
        });
    },]);

    addVariant('stepper-between', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
            return `[data-stepper].between .${e(`stepper-between${separator}${className}`)}`;
        });
    },]);

    addVariant('stepper-last', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
            return `[data-stepper].last .${e(`stepper-last${separator}${className}`)}`;
        });
    },]);

    addVariant('stepper-item-active', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('stepper-item-completed', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
    ...
    addVariant('stepper-item-pending', [({modifySelectors, separator}) => {
        modifySelectors(({className}) => {
